...
class ProductsOfCategoryInShopPagingSource (val shopId: String, val request: GetProductsOfCategoryInShopRequest, private val shopApi: IShopApi): PagingSource<Int, Product>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        return try {
            ...
            val response = shopApi.getProductsOfCategoryInShop(shopId = shopId,request)
