...
class SearchProductPagingSource (val searchWords: String, val request: GetProductsRequest, private val productApi: IProductApi): PagingSource<Int, Product>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        return try {
            ...
            val response = productApi.search(searchWords, request)
