...
import vn.ztech.software.ecom.databinding.FragmentListProductsOfCategoryInShopBinding
...
open class ListProductsOfCategoryInShopFragment : Fragment() {

    private lateinit var binding: FragmentListProductsOfCategoryInShopBinding
    private val viewModel: ListProductsOfCategoryInShopViewModel by viewModel()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.takeIf { it.containsKey("category") }?.let {
            ...
            viewModel.getProductsOfCategoryInShop(shopViewModel.shopId.value, viewModel.currentSelectedCategory.value?.name)
        }
    ...
    override fun onCreateView(
        ...
        binding = FragmentListProductsOfCategoryInShopBinding.inflate(layoutInflater)
        setViews()
        setObservers()
        return binding.root
    }
        ...
        listProductsAdapter.onClickListener = object : ListProductsAdapter.OnClickListener {
            override fun onClick(productData: Product) {
                findNavController().navigate(
                    R.id.action_listProductsOfCategoryInShopFragment_to_productDetailsFragment,
