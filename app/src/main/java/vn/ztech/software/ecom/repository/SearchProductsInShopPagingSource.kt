...
class SearchProductsInShopPagingSource (val searchWords: String, val request: SearchProductsInShopRequest, private val shopApi: IShopApi): PagingSource<Int, Product>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        return try {
            ...
            val response = shopApi.searchProductsInShop(searchWords, request)
