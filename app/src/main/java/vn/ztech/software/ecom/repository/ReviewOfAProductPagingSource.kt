...
class ReviewOfAProductPagingSource (val productId: String, val request: GetReviewsRequest, private val reviewApi: IReviewApi): PagingSource<Int, Review>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Review> {
        return try {
            ...
            val response = reviewApi.getListReviewOfAProduct(productId = productId, request)
