...
class ProductsInShopPagingSource (val shopId: String, val request: GetProductsRequest, private val shopApi: IShopApi): PagingSource<Int, Product>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        return try {
            ...
            val response = shopApi.getProductsInShop(shopId = shopId,request)
